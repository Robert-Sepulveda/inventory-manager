...
$sql = "Select `auto_id`,`device_type` from `device_types` where `status`='active'";
try{
...
{
	$devices[$data['auto_id']]=$data['device_type']; // use the auto_id to bind to the corresponding name
}
